...
urlspatterns = [
	...
	path('entradas/', include([
		...
		path('<int:_id>/asiento/', views.asiento_entrada, name='vAsientoEntrada'),
		path('<int:_id>/detalle/', views.detalle_entrada, name='vDetalleEntrada'),
		path('almacen/<int:_id>/fecha/', views.entradas_por_fecha, name='vEntradasPorFecha'),
		path('almacen/<int:_id>/rango/', views.entradas_por_rango, name='vEntradasPorRango'),
		])),
	...
	path('traslados/', include([
		path('', views.lista_traslados, name='vListaTraslados'),
		])),
]