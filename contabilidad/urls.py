...
urlpatterns = [
	...
	path('cuentas/', include([
		...
		path('ver/<str:_id>/', views.detalle_cuenta, name='vDetalleCuenta'),
	...
	path('asientos/', include([
		...
		path('periodo/<int:_id>/', views.indice_asientos, name='vAsientosPeriodo'),
		path('fechas/', views.indice_asientos_fecha, name='vAsientoPorFecha'),
